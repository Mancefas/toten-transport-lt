...
describe('Header component tests', () => {
    it('renders header with company logo and navigation links', () => {
        ...
        expect(screen.getByRole('link', { name: TranslationsENG.Header.logoAlt })).toHaveAttribute('href', '/');
        expect(screen.getByRole('link', { name: TranslationsENG.Header.aboutLink.name})).toBeInTheDocument()
        expect(screen.getByRole('link', { name: TranslationsENG.Header.contactsLink.name})).toBeInTheDocument()
      });
})